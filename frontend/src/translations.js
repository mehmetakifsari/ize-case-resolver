...
export const translations = {
  tr: {
    ...
    setup2faTitle: "2FA Kurulumu Gerekli",
    setup2faDescription: "Güvenliğiniz için panele devam etmeden önce Google Authenticator ile 2FA kurulumu tamamlayın.",
    setup2faQrAlt: "2FA kurulum karekodu",
    setup2faStep1: "1) Google Authenticator uygulamasını açın.",
    setup2faStep2: "2) QR kodu okutun veya aşağıdaki gizli anahtarı manuel girin.",
    setup2faStep3: "3) Uygulamanın ürettiği 6 haneli kodu doğrulayın.",
    setup2faSecretLabel: "Gizli anahtar",
    setup2faActivate: "2FA'yı Aktifleştir",
    ...
    contactFormRecipientEmail: "Form Alıcı E-postası",
    ...
    contactFormError: "Mesaj gönderilirken bir hata oluştu.",
    companyMap: "Firma Konumu",
    openMap: "Haritada Aç",
  ...
  en: {
    ...
    setup2faTitle: "2FA Setup Required",
    setup2faDescription: "For your security, complete Google Authenticator setup before continuing to the dashboard.",
    setup2faQrAlt: "2FA setup QR code",
    setup2faStep1: "1) Open the Google Authenticator app.",
    setup2faStep2: "2) Scan the QR code or enter the secret key below manually.",
    setup2faStep3: "3) Verify the 6-digit code generated by the app.",
    setup2faSecretLabel: "Secret key",
    setup2faActivate: "Activate 2FA",
    ...
    contactFormRecipientEmail: "Form Recipient Email",
    googleMapsEmbedUrl: "Google Maps Embed URL",
    googleMapsLink: "Google Maps Link",
    ...
    contactFormError: "An error occurred while sending your message.",
    companyMap: "Company Location",
